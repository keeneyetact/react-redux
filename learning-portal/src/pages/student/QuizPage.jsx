...
const QuizPage = () => {
  ...
  const handleOptionChange = (option) => {
    ...
    if (isOptionSelected) {
      ...
      const updatedSelectedOptions = currentAnswers.filter(
  ...
  if (quizDone?.id) {
    content = (
      <NoContent
        message={
          "The Quiz you are trying to participate, that is already given by you...!!"
        }
      />
    );
  }
  ...
  if (!isLoading && !quizDone?.id && quizData?.length === 0) {
    content = (
      <NoContent
        message={
          "The Quiz your are trying to participate is currently not available..."
        }
      />
    );
  }
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-0">
          <div className="mb-8">
            <h1 className="text-2xl font-bold">
              Quizzes for {currentQuiz?.video_title}
            </h1>
                ...
                <div className="text-center pb-6 mt-6">
                  <button
                    ...
                    className={`inline-flex items-center py-2 px-4 text-sm font-medium text-gray-500 ${
                      currentQuestion === 0
                        ? "disabled:opacity-30"
                        : "bg-white cursor-pointer hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                  ...
                  <button
                    ...
                    className={`inline-flex items-center py-2 px-4 ml-3 text-sm font-medium text-gray-500 ${
