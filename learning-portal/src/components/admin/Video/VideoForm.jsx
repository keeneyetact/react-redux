...
import { useEditVideoMutation, useAddVideoMutation } from '../../../features/videos/videosApi'
...
const VideoForm = ({ id, videoData }) => {
    ...
    const [ addVideo, {isLoading: addLoading, isSuccess: addSuccess, error: addError }] = useAddVideoMutation()
    const [ editVideo, { isLoading: editLoading, isSuccess: editSuccess, error: editError } ] = useEditVideoMutation()
