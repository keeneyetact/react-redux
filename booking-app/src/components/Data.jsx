...
import { remove } from '../redux/booking/action'
...
const Data = () => {
  ...
  return (
    ...
    <table className="booking-table">
      {booking?.length ? <><thead className="bg-gray-100/50">
        ...
        <tr key={book.id} className="lws-bookedTable text-black">
          ...
          <td className="px-6 py-4 text-center">
            <div className="flex justify-center gap-4">
              <button onClick={(e)=> handleClick(e, book.id)} className="lws-remove">
      ...
      </tbody> </> : <span>No booking available! Please, book a flight to see data table here.</span>}
    </table>
  </div>
  )
}
